...
import "../../CSS/ValidationModalDossiers.css";

const ValidationModalDossiers = ({
                                     show,
                                     onHide,
                                     validationSummary,
                                     necessaryFields,
    ...
    return (
        <Modal
            show={show}
            onHide={onHide}
            className="dossiers-modals"
            centered
        >
            <Modal.Header closeButton>
                <Modal.Title>Validation des Données de Dossiers</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                {validationSummary.length > 0 ? (
                    ...
                    <p>Les données des dossiers sont valides et prêtes pour l'importation.</p>
                )}
                <Table>
                    <thead>
                    <tr>
...
export default ValidationModalDossiers;
