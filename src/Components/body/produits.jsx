    ...
    export default function Produits() {
        ...
        const validateExcelData = (data) => {
            ...
            data.forEach((row, index) => {
                if (!row["Date Affectation"] || row["Date Affectation"].toString().trim() === "") {
                    row["Date Affectation"] = today;
                }
                ...
                const exampleData = [
                    {
                        ...
                        "Description": "Crème hydratante visage bio - Formule enrichie en huile d'argan",
                        "Catégorie": "Cosmétiques",
                        "Dépôt": "Entrepôt Principal Paris",
                        "Date Affectation": today,
                        "Date Péremption": expiryDate,
                        "Code RFID" : "RF00000123456",
                        "Quantité" : "50",
                        "Sous Catégorie": "Soins Visage",
                        "Marque": "NatureBio",
                        "Model": "Hydra+",
                        "Famille": "Cosmétiques Bio",
                        "Sous Famille": "Crèmes",
                        "Taille": "50ml",
                        "Couleur": "Blanc",
                        "Poids": "75g",
